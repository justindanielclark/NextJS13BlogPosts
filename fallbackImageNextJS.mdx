...
export default someElementWithAUser({src, alt, width, height, className, priority}: Props){
  return (
    <div>
      <Image
        src={src}
...
I've had great success with this pattern. Hopefully, it helps you all out too
